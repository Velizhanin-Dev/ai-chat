...
// в ТОМ ЖЕ браузере первое «Новый проект» подхватывает его и СРАЗУ создаёт проект
// (без повторного визарда — см. chat/page), затем чистит ключ. Работает только на
// том же устройстве/браузере — это норм для QR-сценария.
//

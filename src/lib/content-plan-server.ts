...
const BLOCK_INSTRUCTION: Record<BlockKey, string> = {
  ...
  funnel: `Разложи месячную сетку по воронке. Верни JSON {"funnel":{"parts":[{"format":"reach|expert|selling","share":0.6,"goal":"зачем этот формат в воронке"}],"note":"как балансировать в этой нише"}}. Помни: большинство роликов охватные (растим канал), часть экспертные, продающих меньше всего. Сумма share = 1.`,

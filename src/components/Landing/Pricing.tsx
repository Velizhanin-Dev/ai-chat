...
/* ── Тарифы ───────────────────────────────────────────────────────────── *
 * ПЛЕЙСХОЛДЕРЫ: цены условные. Проставьте реальную тарификацию перед запуском. */
const PLANS = [
  {
    name: "Старт",
    price: "0 ₽",
  ...
  },
  {
    ...
    features: [
      "Безлимит сценариев",
      "Все 12 форматов + длинные видео",
      "Хуки, превью, названия и CTA",
      "История диалогов",
    ],
    cta: "Попробовать",
    href: "/chat",
...
const FAQ = [
  ...
  },
  {
    ...
    a: "На базе студии: книге про длинные видео, постах из открытого и закрытого каналов, библиотеке из 12 форматов и списке антипаттернов. Перед генерацией модель сверяется с эталонами, а не сочиняет «из головы».",
  },
  {
    q: "Заменит ли это сценариста?",
  ...
  },
  {
    ...
    a: "Да. Для коротких видео есть 12 эталонных форматов — называете идею, получаете готовую структуру под формат. Для длинных видео работает логика удержания из книги.",
  },
  {
      ...
      <Section id="pricing" alt>
        <Reveal>
          <SectionHeading
            ...
            subtitle="Попробуйте без оплаты. Перейдёте на платный тариф, когда сценарии станут частью рутины."
          />
        </Reveal>
